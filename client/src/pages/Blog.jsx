...
const blogData = [
  {
    ...
    image: "https://res.cloudinary.com/dsvotvxhq/image/upload/v1719816330/INEXT/lkbipkdiyl1gtri4papk.jpg",
    createdAt: "2024-07-01T06:45:23.924Z"
  },
  {
    _id: "66a4d8bbd5954d17852bac59",
    title: "Premium Foxnuts (Makhana) - The Superfood Snack for a Global Market",
    ...
    image: "https://res.cloudinary.com/dsvotvxhq/image/upload/v1722079419/INEXT/gtvlbiucf4hfhxfd2dy1.jpg",
          ...
          {blogData.map((article, index) => (
            ...
            >
              ...
              <div className="px-6 py-4">
                ...
                <p className="text-gray-700 text-base">{article.desc.slice(0, 100)}...</p>
              </div>
              <div className="px-6 py-4">
