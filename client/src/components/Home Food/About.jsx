...
function AboutSection() {
  ...
  <div className="absolute bottom-8 right-4 text-white font-bold text-lg z-10 text-center bg-white lg:p-4 p-1 rounded-lg shadow-lg backdrop-filter backdrop-blur-sm" style={{ backgroundColor: 'rgba(255, 255, 255, 0.7)' }}>
      ...
      <p className="text-[#e2571a] font-sans italic text-lg">About RISI Home Foods</p>
      ...
      <p className="text-[#5A5A5A] mt-2 leading-relaxed text-[12px] lg:text-[14px]">
        RISI Home Foods is a dynamic import-export enterprise committed to facilitating seamless global trade.
        ...
        and spices from Surat, where we consistently uphold excellence in every shipment. At RISI Home Foods, our mission
