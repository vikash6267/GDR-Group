      ...
      >
        <div className="mb-4">
          ...
          <input
            ...
            id="name"
            name="name"
            className="w-full  text-xl px-3 py-2 border border-red-600 h-16 rounded-lg "
            value={formData.name}
        ...
        <div className="mb-4">
          ...
          <select
            id="position"
            name="applicationFor"
            className=" text-xl w-full px-3 py-2 border border-red-600 h-16 rounded-lg"
        ...
        <div className="mb-4">
          ...
          <textarea
            id="message"
            name="message"
            className="w-full text-xl px-3 py-2 border border-red-600 h-36 rounded-lg"
        ...
        <button
          type="submit"
          className="px-5 py-3 bg-red-600 text-white text-xl"
        >
          Submit
        </button>
      </form>
